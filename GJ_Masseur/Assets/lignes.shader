    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float m = smoothstep(0.1,0. ,li(i.uv*fac+float2(t,0.)*0.4+t3*0.2, float2(0.5, 0.1)*fac, float2(0.5, 0.95)*fac));
                m += smoothstep(0.1 , 0. , li(i.uv * fac + float2(t2, 0.) * 0.4-t3*0.2, float2(0.5, 0.1) * fac, float2(0.5, 0.95) * fac));
